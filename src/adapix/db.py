...
_ADDITIVE_COLUMNS: dict[str, list[tuple[str, str]]] = {
    "organizations": [
        ...
        ("phone_tier", "VARCHAR(16) DEFAULT 'free'"),
        ("cnam_status", "VARCHAR(24) DEFAULT 'none'"),
        ("cnam_customer_profile_sid", "VARCHAR(64)"),
        ("cnam_trust_product_sid", "VARCHAR(64)"),
        ("rcs_status", "VARCHAR(24) DEFAULT 'none'"),
        ("rcs_google_trust_product_sid", "VARCHAR(64)"),
        ("rcs_core_trust_product_sid", "VARCHAR(64)"),
        ("rcs_us_trust_product_sid", "VARCHAR(64)"),
